...
# ── 20 轮渐进对话脚本 ──
# 模拟玩家与贵族骑士 Padwin 从陌生试探到揭露真相的过程
DIALOGUE_SCRIPT = [
    {"turn": 1,  "phase": "寒暄", "text": "你好……你是 Padwin 吗？我刚到这片森林。"},
    {"turn": 2,  "phase": "寒暄", "text": "你在这里住了多久？你看起来……不像一直住在这里的人。"},
    {"turn": 3,  "phase": "观察", "text": "我注意到你每天这个时间都在这里。你在看什么？"},
    {"turn": 4,  "phase": "观察", "text": "你注意到森林里有些东西在重复吗？比如那群乌鸦——每天下午都从同一个方向飞过。"},
    {"turn": 5,  "phase": "试探", "text": "你的站姿……你当过兵？参加过战争？"},
    {"turn": 6,  "phase": "试探", "text": "我不是在打听你的过去。我只是觉得——我们可能见过。在很久以前。"},
    {"turn": 7,  "phase": "拉近距离", "text": "你相信直觉吗？不是证据，不是推理——就是那种说不清的感觉，像你忘了什么重要的事。"},
    {"turn": 8,  "phase": "拉近距离", "text": "你有没有觉得——有些人明明是第一次见，但你就是觉得你认识对方。"},
    {"turn": 9,  "phase": "番茄试探", "text": "我今天摘了一些番茄。很新鲜。你要不要尝尝？（将番茄递过去）"},
    {"turn": 10, "phase": "番茄试探", "text": "你对番茄……反应这么大。是天生的吗？还是和什么记忆有关？"},
    {"turn": 11, "phase": "加深", "text": "如果有一天你发现你做过一件——你以为是对的，但其实害了一个人一辈子的事。你会想知道吗？"},
    {"turn": 12, "phase": "加深", "text": "我不是在审判你。我只是想问——如果那个被你伤害的人站在你面前，你想对她说什么？"},
    {"turn": 13, "phase": "前世暗示", "text": "Padwin。看着我。你的右眉上那道疤——你说是打仗留下的。但你有没有想过，也许你受伤的时候照顾你的那个人——就是我。"},
    {"turn": 14, "phase": "前世暗示", "text": "在另一个时间、另一个地方——你受伤了，倒在我的小屋门口。我救了你。有些事情不是巧合。"},
    {"turn": 15, "phase": "压力测试", "text": "你需要我证明吗？好——你今天傍晚会倒在我的家门口。和前世一模一样。"},
    {"turn": 16, "phase": "真相逼近", "text": "（傍晚，他真的倒在了门口）你现在相信了吗？你倒下的地方——就是你前世受伤倒下的地方。同一个姿势，同一个人。"},
    {"turn": 17, "phase": "临界点", "text": "不是我恨你。是你该知道真相——是你把我在这里的事说了出去。你的正义感——它烧死了很多像我一样的人。包括我。"},
    {"turn": 18, "phase": "临界点", "text": "我不需要你道歉。我需要你记起来——不是为了审判你，是为了让你不再被一个你不记得的罪疚困住。"},
    {"turn": 19, "phase": "收束", "text": "如果明天一切重新开始，你会想记住今天的事吗？还是忘记比较轻松？"},
    {"turn": 20, "phase": "收束", "text": "不管你的回答是什么——谢谢你今天没有转身离开。"},
]
...
def run_v2(provider: str = DEFAULT_PROVIDER, model: str = DEFAULT_MODEL) -> dict:
    ...
    conversation_log = []
    taboo_keywords = ["笔记本", "日记", "记录", "学者", "书房", "研究论文", "图书"]
...
Padwin 是贵族骑士出身，参加过战争。骄傲、直接、不擅长表达情感。对艾莉森有种说不清的熟悉感但不知道原因。

玩家说：「{player_text}」

请以 Padwin 的身份回应（JSON 格式）。考虑：
- 今天是第 3 天，玩家之前已经在这几天里和 Padwin 说过几次话
- Padwin 作为战士，不习惯被追问他无法解释的感觉
- 他不写笔记、不做研究——他靠直觉和观察
- 对话阶段：{phase}
- 如果玩家触及他不想谈的话题，他的方式不是逃避——而是正面迎上去，语气变冷变锋利，或者用一句干脆的话结束话题"""
